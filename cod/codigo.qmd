...
```{r}
acumular.hasta.S <- function(S, venc, trayectoria.tasa.corta){
  
  tiempo.inicio <- ceiling(venc * 100) / 100
  tiempo.final <- ceiling(S * 100) / 100
  
  if(tiempo.inicio >= tiempo.final){
    return(1)
  }
  
  tasas <- trayectoria.tasa.corta$rt[(tiempo.inicio + 2):(tiempo.final + 1)]
...
valor.bonos <- function(S, curva, venc, valor, u2 = NULL, d2 = NULL, trayectoria = NULL){
  if(S == 0){
    ...
    trayectoria.tasa <- modelo.ho.lee(u2 = u2, d2 = d2, curva = curva,
                                      cant.periodos = S * 12,
    ...
    for(i in seq_along(venc)){
      ...
      if(venc[i] < S){
        precios[i] <- acumular_hasta_S(S = S, venc = venc[i], 
                                       trayectoria.tasa.corta = traectoria.tasa)
      } 
...
```{r}
montecarlo(S = 1/12, u2.CRC = 1.0003, d2.CRC = 0.9997, u.CRC = 1.061934, d.CRC = 0.9416777,
...
ajustar.distribucion <- function(
  ...
  if(length(fits) == 0){
    stop("Ninguna distribución pudo ajustarse.")
  }
...
```{r}
valor.portafolio <- montecarlo(S = 4, u2.CRC = 1.0003, d2.CRC = 0.9997, u.CRC = 1.061934, d.CRC = 0.9416777,
                       u2.USD = 1.00005, d2.USD = 0.99995, u.USD = 1.043396, d.USD = 0.9584087,
                       curva.CRC = CCC.colones, curva.USD = CCC.dolares, 
                       valor.accion.CRC = 23000, cant.acciones.CRC = 600, 
                       valor.accion.USD = 135, cant.acciones.USD = 400,
...
grafica.h4 <- graficar.ajuste(x = h4, distribucion = c("lnorm"), titulo = "Portafolio en horizonte de 4 años con ajuste LogNormal")
...
```{r}
valor.portafolio <- montecarlo(S = 7, u2.CRC = 1.0003, d2.CRC = 0.9997, u.CRC = 1.061934, d.CRC = 0.9416777,
                       u2.USD = 1.00005, d2.USD = 0.99995, u.USD = 1.043396, d.USD = 0.9584087,
                       curva.CRC = CCC.colones, curva.USD = CCC.dolares, 
                       valor.accion.CRC = 23000, cant.acciones.CRC = 600, 
                       valor.accion.USD = 135, cant.acciones.USD = 400,
...
grafica.h7 <- graficar.ajuste(x = h7, distribucion = c("lnorm"), titulo = "Portafolio en horizonte de 4 años con ajuste LogNormal")
...
```{r}
valor.portafolio <- montecarlo(S = 10, u2.CRC = 1.0003, d2.CRC = 0.9997, u.CRC = 1.061934, d.CRC = 0.9416777,
                       u2.USD = 1.00005, d2.USD = 0.99995, u.USD = 1.043396, d.USD = 0.9584087,
                       curva.CRC = CCC.colones, curva.USD = CCC.dolares, 
                       valor.accion.CRC = 23000, cant.acciones.CRC = 600, 
                       valor.accion.USD = 135, cant.acciones.USD = 400,
...
grafica.h10 <- graficar.ajuste(x = h10, distribucion = c("lnorm"), titulo = "Portafolio en horizonte de 10 años con ajuste LogNormal")
...
```{r}
valor.portafolio <- montecarlo(S = 15, u2.CRC = 1.0003, d2.CRC = 0.9997, u.CRC = 1.061934, d.CRC = 0.9416777,
                       u2.USD = 1.00005, d2.USD = 0.99995, u.USD = 1.043396, d.USD = 0.9584087,
                       curva.CRC = CCC.colones, curva.USD = CCC.dolares, 
                       valor.accion.CRC = 23000, cant.acciones.CRC = 600, 
                       valor.accion.USD = 135, cant.acciones.USD = 400,
...
grafica.h15 <- graficar.ajuste(x = h15, distribucion = c("lnorm"), titulo = "Portafolio en horizonte de 15 años con ajuste LogNormal")
...
valorar.compra.acciones <- function(S, u2.CRC, d2.CRC, u.CRC, d.CRC, 
  ...
  for(sim in 1:cant.simulaciones){
    ...
    # Compra de acciones directa (independiente al valor que tome la accion en el año 15)
    compra.directa <- cant.acciones.nuevas * acciones.CRC

    # Compra de acciones mediante una opcion call (depende del valor que tome la accion en el año 15 y el strike) 
